...
export const enviaEmail = async (transporter: any, token: string, email: string) => {
    await transporter.sendMail({
        ...
        html: '<h1>Validação de email</h1> <p>Clique no link para validar sua conta no acompi.</p><a href=https://acompi-back-end-lhbe.onrender.com/cadastro/' + token + '> Clique aqui</a>', // html body
        text: "Clique no link para validar sua conta no acompi.\n <a href=https://acompi-back-end-lhbe.onrender.com/cadastro/" + token + ">Clique aqui</a>", // plain text body
    });
    return;
};
